...
2. Enter with user test@liferay.com, update the password to: teste (!Important: this user/password is going to be used by the react application, that's why you must to config it correctly)
